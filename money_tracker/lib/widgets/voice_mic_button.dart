              ...
              child: Center(
                child: AnimatedBuilder(
                  ...
                  builder: (context, child) {
                    return Container(
                      width: widget.size * 2.8 * (0.5 + _ripple1Controller.value * 0.5),
                      height: widget.size * 2.8 * (0.5 + _ripple1Controller.value * 0.5),
                      decoration: BoxDecoration(
                        shape: BoxShape.circle,
                        border: Border.all(
                          color: primaryColor.withOpacity(0.1 * (1 - _ripple1Controller.value)),
                          width: 1,
                        ),
                      ),
                    );
            ...
            Positioned(
              ...
              child: Center(
                child: AnimatedBuilder(
                  ...
                  builder: (context, child) {
                    return Container(
                      width: widget.size * 2.8 * (0.5 + _ripple2Controller.value * 0.5),
                      height: widget.size * 2.8 * (0.5 + _ripple2Controller.value * 0.5),
                      decoration: BoxDecoration(
                        shape: BoxShape.circle,
                        border: Border.all(
                          color: primaryColor.withOpacity(0.1 * (1 - _ripple2Controller.value)),
                          width: 1,
                        ),
                      ),
                    );
            ...
            Positioned(
              ...
              child: Center(
                child: AnimatedBuilder(
                  ...
                  builder: (context, child) {
                    return Container(
                      width: widget.size * 2.8 * (0.5 + _ripple3Controller.value * 0.5),
                      height: widget.size * 2.8 * (0.5 + _ripple3Controller.value * 0.5),
                      decoration: BoxDecoration(
                        shape: BoxShape.circle,
                        border: Border.all(
                          color: primaryColor.withOpacity(0.1 * (1 - _ripple3Controller.value)),
                          width: 1,
                        ),
                      ),
                    );
                ...
                child: AnimatedBuilder(
                  ...
                  builder: (context, child) {
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        shape: BoxShape.circle,
                        color: primaryColor.withOpacity(0.05 + 0.05 * _pulseController.value),
                        border: Border.all(
          ...
          GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: primaryColor.withOpacity(widget.isListening ? 0.6 : 0.3),
              ...
              child: Center(
                child: widget.isProcessing
                    ...
                    : Icon(
                        widget.isListening ? LucideIcons.micOff : LucideIcons.mic,
